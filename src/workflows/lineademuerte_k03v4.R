...
dir.create("~/buckets/b1/exp/lineademuertev4/", showWarnings = FALSE)
setwd( "~/buckets/b1/exp/lineademuertev4/" )
...
dataset[, fold_train :=  foto_mes <= 202107 &
          !(foto_mes %in% c(202002, 202003, 202004, 202005, 202006)) &
          (clase_ternaria %in% c("BAJA+1", "BAJA+2") |
             azar < 0.4 ) ]
...
fwrite(tb_entrega, file = "lineademuerte_11000v4.csv" )
