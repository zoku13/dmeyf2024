...
envg$EXPENV$semilla_primigenia <- 103301
...
# param_local$future <- c(202108)
  ...
  param_local$final_train$training <- c(
    ...
    # 202006  Excluyo 202004,202003,202005,202104
    202002, 202001,
    201912, 201911,
  ...
  param_local$train$training <- c(
    ...
    202012, 202011, 202010, 202009, 202008, 202007, 
    # Excluyo 202006, 202005, 202004, 202003,202104
    202002, 202001,
    201912, 201911,
    # 201910 Excluyo por variables rotas
    201909, 201908, 201907, 201906,
...
wf_SEMI_df <- function( pnombrewf )
{
  param_local <- exp_wf_init( pnombrewf ) # linea fija

  # Etapa especificacion dataset de la Segunda Competencia Kaggle
  DT_incorporar_dataset( "~/buckets/b1/datasets/competencia_03_julia.csv.gz")
