...
dir.create("~/buckets/b1/exp/lineademuertev3/", showWarnings = FALSE)
setwd( "~/buckets/b1/exp/lineademuertev3/" )
...
dataset[, fold_train :=  foto_mes <= 202107 &
          !(foto_mes %in% c(201903, 201904, 202003, 202004, 202103, 202104)) &
          (clase_ternaria %in% c("BAJA+1", "BAJA+2") |
             azar < 0.2 ) ]
...
fwrite(tb_entrega, file = "lineademuerte_11000v3.csv" )
